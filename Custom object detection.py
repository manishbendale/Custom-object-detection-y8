...
st.set_page_config(page_title="Agriculture App with Object Detection", layout="wide", page_icon="./bcd.ico")
st.title("Agriculture App with Object Detection")
# create select box for selecting ultralytics YOLOv8 model
model_select = st.selectbox(
    "Selected Object Detection Model(Note: for Harvest/Non-harvest setect Best model)",
    [
        "yolov8n", "yolov8s", "yolov8m", "yolov8l", "yolov8x",
        "yolov8n-seg", "yolov8s-seg", "yolov8m-seg", "yolov8l-seg", "yolov8x-seg", 'best','best_segement'
    ]
)
print(f"Selected Model(for Harvest/Non-harvest setect Best model): {model_select}.pt")
...
with tab_live_stream:
    st.header("Object detection in Live Stream")
